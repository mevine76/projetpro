    ...
    <div class="container">
      ...
      <div class="mb-3">
        <form action="../controllers/controller_confirmation.php" method="POST">
          ...
          <div class="row mb-3">
            <div class="col">
              <input type="text" name="lastname" class="form-control" placeholder="Nom" aria-label="lastname" required pattern="[A-Za-zÀ-ÖØ-öø-ÿ-]+">
            </div><br>
            <div class="col">
              <input type="text" name="firstname" class="form-control" placeholder="Prénom" aria-label="firstname" required pattern="[A-Za-zÀ-ÖØ-öø-ÿ-]+">
            </div>
          </div>
